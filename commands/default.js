...
/* Tree prints the directory tree from the json file. */
...
COMMANDS.help = function(argv, cb) {
    this._terminal.write(
        'You can navigate through by either clicking on anything that ' +
        ...
        'of that directory. The command "ls -l" can also list the contents in a ' +
        'different format. The contents of a <span class="text">file</span> ' +
