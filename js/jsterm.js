...
(function() {
   ...
   var Terminal = {
      ...
      scroll: function() {
         var scrollItem = document.getElementsByClassName('terminal')[0];
   ...
   term.init(CONFIG, '/json/directory.json', COMMANDS, function() {
      term.enqueue('login') //Login will take in the next two.
          .enqueue('sebastian')//Username
          .enqueue('******')//Password
          .enqueue('cat welcome')//Welcome to the website.
          .enqueue('cat about')//Currently status
          .enqueue('tree')
          .begin(document.getElementById("jsterm_container"));
   });
